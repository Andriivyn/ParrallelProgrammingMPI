...
/*
Does reducton for process i, summing values of all <=i processes data
*/
...
/*
Output:
root@b1a37b43d450:/DAP/src/main/java/com/mathpar/NAUKMA/riepkin# sh run_test.sh 2 TestScan         
myrank = 0: a = [0, 1, 2, 3, 4]
myrank = 0: q = [0, 1, 2, 3, 4]
myrank = 1: a = [10, 11, 12, 13, 14]
myrank = 1: q = [10, 12, 14, 16, 18]
root@b1a37b43d450:/DAP/src/main/java/com/mathpar/NAUKMA/riepkin# sh run_test.sh 4 TestScan
myrank = 1: a = [10, 11, 12, 13, 14]
myrank = 0: a = [0, 1, 2, 3, 4]
myrank = 1: q = [10, 12, 14, 16, 18]
myrank = 0: q = [0, 1, 2, 3, 4]
